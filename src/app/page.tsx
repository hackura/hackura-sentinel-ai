  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-black via-purple-900/10 to-black">
      ...
      <section className="px-6 py-20 md:py-32 text-center">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold leading-tight mb-6 bg-gradient-to-r from-purple-200 via-white to-purple-300 bg-clip-text text-transparent tracking-tight px-2">
